...
def historia(request):
    ...
    return render_to_response('historia.html',{'recetas':recetas}, context_instance=RequestContext(request))
	
def zona(request):
    recetas = Receta.objects.all()
    return render_to_response('zona.html',{'recetas':recetas}, context_instance=RequestContext(request))

def organigrama(request):
    recetas = Receta.objects.all()
    return render_to_response('organigrama.html',{'recetas':recetas}, context_instance=RequestContext(request))

def acerca(request):
    recetas = Receta.objects.all()
    return render_to_response('acerca.html',{'recetas':recetas}, context_instance=RequestContext(request))
...
def detalle_receta(request, id_receta):
    ...
    return render_to_response('receta.html',{'noticia':dato,'comentarios':comentarios}, context_instance=RequestContext(request))
